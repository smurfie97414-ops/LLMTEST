...
- Generated: 2026-06-30T06:22:31
- Files indexed: 48
- Symbols indexed: 540
- Symbol files scanned: 41 of 41 candidates
- Git: branch `main`, head `3425c6f`, changed entries `11`
...
- `cortex3_llm.py`: py:__init__, py:__post_init__, py:_json_default, py:_write_json, py:bos_id, py:decode, py:encode, py:eos_id, py:from_paths, py:iter_chunks, py:LLMTokenizer, py:load, py:pad_id, py:save, py:TextCorpusConfig, py:TextShardReader, py:to_dict, py:TokenizedCorpusBuilder, py:TokenizedCorpusManifest, py:train, py:vocab_size
...
- `tests/test_llm_pretraining.py`: py:_corpus, py:LLMPretrainingHarnessTest, py:test_bpe_tokenizer_and_memmap_corpus_are_streamable, py:test_cortex_comparison_produces_checkpoints_curves_and_cost_win, py:test_cuda_requirement_is_explicit_not_silent_fallback

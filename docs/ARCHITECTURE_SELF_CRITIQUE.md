...
- Statut: corrige pour le biais top-N dans l'autosize mesure par defaut. Restent a durcir: search plus large, mesures de pic VRAM plus longues, seuils GPU plus ambitieux et preuve comparative baseline/Cortex a l'echelle.

## Critique phase par phase - boucle 24
...
1. P2: elargir la recherche autosize mesuree/diversifiee a plus de candidats, plus de seeds et des profils plus longs sous budget VRAM observe.

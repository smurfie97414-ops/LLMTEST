...
- Statut: corrige pour la selection autosize multi-seed courte. Restent a durcir: plus de candidats, plus grosses shapes, plus de steps, suivi de pic VRAM plus long et preuve comparative baseline/Cortex a l'echelle.

## Critique phase par phase - boucle 23

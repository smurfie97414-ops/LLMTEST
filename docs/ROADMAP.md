...
- Phase 2: compressed core instrumentation
  ...
  - Next hardening: run a more sustained GPU/VRAM/CPU monitoring window on larger LLM-shaped batches, then add a WMMA/Tensor Core grad-weight variant only if those shapes need it.

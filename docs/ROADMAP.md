...
- Phase 2: compressed core instrumentation
  ...
  - Next hardening: increase GPU occupancy on larger LLM-shaped strict-extension batches, then add a WMMA/Tensor Core grad-weight variant only if those shapes need it.

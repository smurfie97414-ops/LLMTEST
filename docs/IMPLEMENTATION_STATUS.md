...
- Cortex phase replay batches, future-contract ledger decisions and bounded ternary compression trace histories are now saved in checkpoints and restored on resume, so long runs do not lose sleep/consolidation, P2 instrumentation or P3 contract state after interruption.

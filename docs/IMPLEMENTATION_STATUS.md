...
- Target the forward packed matmul if large-shape profiling shows it as the next bottleneck, then extend latency/VRAM/energy evidence under real LLM batches.

...
- Increase GPU occupancy on larger LLM-shaped strict-extension batches, and add a WMMA/Tensor Core grad-weight variant only if the tiled kernel is not enough on those shapes.

...
- Broaden the measured, observed-VRAM-budgeted, gradient-accumulation-aware and multi-seed automatic batch/shape search to larger and longer LLM batches, wider candidate grids and higher utilization gates.

...
- Broaden the measured, observed-VRAM-budgeted and gradient-accumulation-aware automatic batch/shape search to larger and longer LLM batches, more seeds and higher utilization gates.

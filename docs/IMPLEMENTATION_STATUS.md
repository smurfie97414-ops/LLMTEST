...
- Run a short multi-shape latency/VRAM/energy matrix for the strict extension path, and add a WMMA/Tensor Core grad-weight variant only if the tiled kernel is not enough on larger LLM-shaped batches.

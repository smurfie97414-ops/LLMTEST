...
- Extend the current tiled/warp CuPy RawKernels toward lower-level CUDA/C++ packaging, reduce or fuse the remaining dense `grad_weight` STE cost, and run latency/VRAM/energy benchmarks across larger LLM-shaped batches.

...
- Manifest experiment proof through `codex-test`: `4/4` corpus-seed samples passed, win-rate `1.0`, mean Cortex/baseline ratio `12.184x`, median ratio `9.613x`, minimum ratio `6.813x`, mean baseline score `0.019043`, max next-token-loss regression ratio `1.001864`.

...
- Broaden the adaptive diverse measured, observed-VRAM-budgeted, gradient-accumulation-aware, minimum-two-measurement-seed and robust-score automatic batch/shape search to larger and longer LLM batches, wider candidate grids and higher utilization gates.

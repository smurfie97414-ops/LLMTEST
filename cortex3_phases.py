...
CORTEX3_PHASES: tuple[Phase, ...] = (
    ...
    Phase("P8", "Fast/Normal/Careful Inference", "Route each task to the cheapest safe cognitive path.", ("difficulty router", "budget predictor", "early-exit policy", "careful fallback"), ("easy tasks get faster", "hard tasks remain accurate", "verification is hierarchical")),
    Phase("P9", "Sleep Phase Anti-Collapse", "Consolidate verified synthetic and real examples without self-poisoning.", ("failure replay buffer", "verified synthetic pool", "anti-collapse reservoir"), ("synthetic data is labeled", "diversity is preserved", "frontier skills improve")),
    Phase("P10", "Recursive Improvement Gate", "Evaluate proposed project improvements only through sandboxed, reversible, verified checks.", ("proposal generator", "sandbox evaluator", "Pareto acceptance gate", "rollback archive"), ("accepted patches improve quality/cost", "protected skills never regress")),
)

...
2. Durcir Phase 2 au-delà de la matrice WMMA courte : profiler le forward packed matmul sur grandes shapes, ajouter une variante Tensor Core/decode-shared s'il devient limitant, puis benchmarker latence/VRAM/énergie sous vrais batchs LLM.

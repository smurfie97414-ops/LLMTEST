...
- `cortex3_sleep.py` : Phase 9 sleep anti-collapse avec replay d'échecs, données synthétiques vérifiées et labellisées, réservoir réel/exogène, familles métamorphiques, filtre anti-collapse, scheduler de consolidation et promotion de familles acceptées en circuits Frontier persistants retenus par la mémoire P4 ;
